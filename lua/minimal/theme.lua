...
M.base = {
    ...
    CurSearch    = { fg = colors.bg, bg = "#ffffff" },
    ...
    IncSearch  = { fg = colors.bg, bg = "#ffffff" },
    ...
    Search              = { fg = colors.bg, bg = colors.gray_search },
    ...
    Substitute          = { fg = colors.bg, bg = colors.gray_search },
